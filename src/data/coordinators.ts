...
export const BATCH_COORDINATORS: BatchCoordinator[] = [
  ...
  },
  {
    ...
    category: "2000s",
    coordinators: [
      { name: "মোঃ গিয়াস উদ্দিন", phone: "01797-992485", role: "প্রাথমিক সমন্বয়ক" },
      { name: "মোঃ শাহীন মিয়াজী", phone: "01675-392125", role: "প্রাথমিক সমন্বয়ক" },
      { name: "মোঃ রেজাউল করিম", phone: "01891-920893", role: "প্রাথমিক সমন্বয়ক" },
      { name: "ইব্রাহিম (নাবিল)", phone: "01856-083111", role: "প্রাথমিক সমন্বয়ক" },
      { name: "সুজা খান", phone: "01670-075483", role: "প্রাথমিক সমন্বয়ক" },
      { name: "মোঃ ফারুক হোসেন", phone: "01761-940199", role: "প্রাথমিক সমন্বয়ক" }
    ]
  },
  {
    id: "batch-2004",
