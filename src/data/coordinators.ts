...
export const EVENT_NOTICES: EventNotice[] = [
  ...
  },
  {
    ...
    descriptionBn: "মূল অ্যালামনাই রেজিস্ট্রেশন ফি ১,০০০ টাকা (স্মারক উপহার, টি-শার্ট ও খাবার অন্তর্ভুক্ত)। অতিথিদের রেজিস্ট্রেশন ফি ১,০০০ টাকা (তবে অতিথিরা কোনো টি-শার্ট পাবেন না)।",
    tagBn: "ফি সংক্রান্ত",
    type: "info"
  },
  {
    ...
    dateBn: "সম্ভাব্য তারিখ ২২ জানুয়ারী, ২০২৭",
    descriptionBn: "দিনব্যাপী বর্ণাঢ্য আনন্দ র‍্যালি, উদ্বোধনী অনুষ্ঠান, স্মৃতিচারণ, গুণীজন সংবর্ধনা, মনোজ্ঞ সাংস্কৃতিক সন্ধ্যা ও গ্র্যান্ড ডিনার।",
    tagBn: "ইভেন্ট সূচি",
    type: "highlight"
  }
];
